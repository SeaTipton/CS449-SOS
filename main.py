...
class SOS(FloatLayout, App):
    ...
    def __init__(self, **kwargs):
        ...
        self.me = Label(text='Sean Tipton CS449',
                        font_size=25,
                        pos_hint={'center_x': .91, 'center_y': .05},
                        color=(0.207, 0.635, 0.423, 0.9))
        self.gamenametv = Label(text='SOS Game Project 449',
                                font_size=100,
        ...
        self.ai_start_btn = Button(text='Game against CPU',
                                size_hint=(.15, .1),
    ...
    def ai_popup(self):
        """
        opens gamepopup, but with P2 as a CPU.
        """
        self.gamecontent.name2input.text = 'CPU'
